  ...
  <v-container fluid>
    <div class="dashboard-page">
      <v-row no-gutters class="d-flex justify-space-between mt-10 mb-6">
        <h3 class="page-title">show estimate</h3>

        <v-menu offset-y>
          <template v-slot:activator="{ on, attrs }">
            <router-link to="/appels_doffres">
              <v-btn
                v-bind="attrs"
                v-on="on"
                color="secondary"
            ...
            <div id="invoiceholder">
              <div id="invoice" class="effect2">
                <div id="invoice-top">
                  ...
                  <div class="title">
                    <h1>
                      estimate #<span class="invoiceVal invoice_num">{{
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            <td>
                              <span>name</span
                              ><label id="invoice_total">name client</label>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <span>phone</span
                              ><label id="currency"> Number client</label>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <span>adress </span
                              ><label id="payment_term"> adress client</label>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <span>mail</span
                              ><label id="invoice_type">mail client</label>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                    ...
                    <table class="table-main">
                      ...
                      >
                        ...
                        <td data-label="Taxable Amount" class="tableitem">
                          {{ element.prixunit * element.quantite }} dt
                        </td>
                      </tr>
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          HTTP.put("offres/refusoffre", oldoffre).then((response) => {
            console.log(response);
            this.$toast.success("offer refused!", {
              position: "top-right",
              timeout: 3000,
            });
          });
