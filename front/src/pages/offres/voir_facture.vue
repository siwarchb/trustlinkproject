  ...
  <v-container fluid>
    <div class="dashboard-page">
      <v-row no-gutters class="d-flex justify-space-between mt-10 mb-6">
        <h3 class="page-title">show invoice</h3>
      ...
      <v-row>
        ...
        <h2>Hello {{devi.client_id.name}} {{devi.client_id.prenom}},</h2>
                      ...
                      <table class="table">
                        <tbody>
                          <tr>
                            <td>
                              <span>Adress</span
                              ><label id="invoice_total">adress client</label>
                            </td>
                          </tr>
                          <tr>
                            <td>
                          ...
                          <tr>
                            <td>
                              <span>name </span
                              ><label id="payment_term"> name client</label>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <span>Email</span
                              ><label id="invoice_type">email client</label>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                ...
                <!--End InvoiceBot-->
                <footer>
                  <div id="legalcopy" class="clearfix"></div>
                </footer>
              </div>
              <!--End Invoice-->
            </div>
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          HTTP.put("offres/acceptoffre", oldoffre).then((response) => {
            ...
            this.$toast.success("offre accepted!", {
              position: "top-right",
            });
          });
        }
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          HTTP.put("offres/refusoffre", oldoffre).then((response) => {
            console.log(response);
            this.$toast.success("offre refused!", {
              position: "top-right",
            });
          });
        }
