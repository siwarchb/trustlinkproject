<template>
  <v-app-bar
    ...
    <v-toolbar-title>TRUSTLINK</v-toolbar-title>
    <v-spacer></v-spacer>
    ...
    <v-menu
      ...
      nudge-bottom="10">
        ...
        <v-list >
          <div class="text-h6 grey--text text--darken-3 px-4 pt-4">{{username}}</div>
  ...
  export default {
    ...
    computed: {
     ...
     mounted(){
       ...
       this.userrole=newObject[0]["role"]
       this.username=newObject[0]["name"]
     },
    methods: {
